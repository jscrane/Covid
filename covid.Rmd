...
The parameter $dbl$ in the plot is the doubling time in days, using the [rule of 70](https://en.wikipedia.org/wiki/Rule_of_72). The parameter $wx$ is the weekly growth factor.
