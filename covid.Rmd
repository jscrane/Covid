...
reliable proxy for the spread of the disease should be the number of deaths. (However it isn't clear how a death is reported as due to the disease: if untested while alive, is a test carried out post mortem?)
